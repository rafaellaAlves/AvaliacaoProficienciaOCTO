...
{
    public abstract class BaseServices<TEntity, TViewModel> : IBasicFunctions<TEntity, TViewModel>
        where TEntity : class
...

    {
        ...
        public BaseServices(ApplicationDbContext.Context.ApplicationDbContext context, string entityIdPropertyName)
        {
