...
{
    public abstract class BaseListServices<TEntity, TViewModel>
        where TEntity : class
        where TViewModel : class
    {
        ...
        public BaseListServices(ApplicationDbContext.Context.ApplicationDbContext context, string entityIdPropertyName)
        {
